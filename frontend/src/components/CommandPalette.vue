    ...
    <div class="modal-card">
      <header class="modal-card-head p-3">
        <b-field class="mb-0" expanded>
          <b-input v-model="search" placeholder="Type a command or search..." icon="magnify" ref="input" @keyup.native.enter="onEnter" />
        </b-field>
      </header>
      <section class="modal-card-body p-0">
        <div class="list is-hoverable">
          <a v-for="(cmd, index) in filteredCommands" :key="cmd.label" 
